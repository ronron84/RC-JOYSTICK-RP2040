 ...
 * Canaux 5-8: Broches 0, 1, 2, 3 (boutons)
 * 
 * Commandes Serial:
...
void setup() {
  ...
  for (int i = 0; i < NUM_CHANNELS; i++) {
    ...
    smoothedValues[i] = analogRead(channelPins[i]);
...
/**
 * Lit et lisse les valeurs analogiques
 * Utilise une moyenne mobile pour réduire le bruit
 */
void readAndSmoothAnalogChannels() {
  // Lecture des valeurs brutes
  for (int i = 0; i < NUM_CHANNELS; i++) {
    rawValues[i] = analogRead(channelPins[i]);
    
    // Ajout à la fenêtre de lissage
  ...
  // Calcul des valeurs lissées (moyenne mobile)
  for (int i = 0; i < NUM_CHANNELS; i++) {
    uint32_t sum = 0;
    for (int j = 0; j < SMOOTHING_SAMPLES; j++) {
...
void updateJoystick() {
  ...
  // Conversion des boutons (canaux 5-8)
...
// =============================================================================
// INTERFACE DE CONFIGURATION SERIAL
// =============================================================================
...
// =============================================================================
// FONCTIONS D'AFFICHAGE ET DIAGNOSTIC
// =============================================================================
...
// =============================================================================
// FONCTIONS DE CONFIGURATION MANUELLE
// =============================================================================
